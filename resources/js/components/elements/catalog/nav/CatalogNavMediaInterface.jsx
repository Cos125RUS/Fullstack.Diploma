...
const CatalogNavMediaInterface = () => {
    return (
        <div className="catalog-main__interface">
            <h5 className="catalog-main__interface-explanation">Выберать подходящий товар</h5>
            <label htmlFor="catalog-menu-checkbox">
                <svg className="catalog-main__interface-cross" width="17.000000" height="17.000000"
...
export default CatalogNavMediaInterface;