...
import {deleteFromCart} from "../../../reducers/siteSlice";
...
const CartItemDelBtn = ({item}) => {
    ...
    return (
        <button className="cart-main__del-btn" onClick={e => delItem(e)}>
            <svg className="cart-main__del-cross" width="10.000000" height="10.000000" viewBox="0 0 10 10" fill="none"
